...
import type { TransactionItem } from '@/domain/budgets/types'
                  ...
                  <td className={styles.detailsCell}>
                    {!isTransfer ? (
                      <span className={styles.categoryTag}>
                        {(item as ItemDisplayFields).categoryName || '—'}
                      </span>
                    ) : (
                  ...
                  <td className={styles.detailsCell}>
                    {!isTransfer ? (
                      <span className={styles.payee}>
                        {(item as ItemDisplayFields).payeeName || '—'}
                      </span>
                    ) : (
                      <span className={styles.payee}>
                        {(item as ItemDisplayFields).otherAccountName || '—'}
                      </span>
                    )}
                  </td>
